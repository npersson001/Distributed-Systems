 ...
 *
 */
public class ANilsAsynchronousCustomDuplexReceivedCallInvokerFactory 
	...
	public DuplexReceivedCallInvoker createDuplexReceivedCallInvoker(
		...
		return new 
				AnAsynchronousSingleThreadDuplexReceivedCallInvoker(new ANilsCustomReceivedCallInvoker(aRemoteHandler, aReplier, anRPCRegistry));
	}
}
