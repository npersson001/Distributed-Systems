...
public class AClientParametersListener implements SimulationParametersListener {
	...
	public void ipcMechanism(IPCMechanism newValue) {
		...
		if(client.getBroadcastIPC()) {
			...
			ASimulationParametersBeanFactory.getSingleton().setIPCMechanism(newValue); // proposal set state
		}
	}
	...
	public void rejectMetaStateChange(boolean newValue) {
		System.out.println("rejectMetaStateChange " + newValue);
		ASimulationParametersBeanFactory.getSingleton().setReject(newValue);
	}
