...
import part4Factories.Part4TracingFactorySetter;
...
@Tags({DistributedTags.CLIENT, DistributedTags.RMI, DistributedTags.NIO, DistributedTags.GIPC, Comp533Tags.CUSTOM_IPC})
public class AClient implements Client {
	...
	public void runExperiment() {
		...
		for(int i = 0; i < 250; i++){
			commandProcessor.setInputString("move 10 10");
			commandProcessor.setInputString("move -10 -10");
		}
...
//		NIOTraceUtility.setTracing();
	...
	public static void main(String[] args) {	
		FactorySetterFactory.setSingleton(new Part4TracingFactorySetter());
